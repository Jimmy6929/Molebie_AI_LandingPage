...
export function GitHubStarBadge() {
  ...
  return (
    <a
      ...
      className="flex items-center gap-2 px-4 py-2 border-2 border-accent-yellow hover:bg-accent-yellow hover:text-base-black transition-colors text-sm font-bold"
    >
      <svg
        width="18"
        height="18"
